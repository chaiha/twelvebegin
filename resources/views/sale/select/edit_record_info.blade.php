				...
				<table class="table table-bordered table-striped">
					...
					<tr>
						...
						<td>
							...
							<option value="dinning_and_beverage" <?php if($select_record->categories=="dinning_and_beverage"){echo "selected";}?>>Dining & Beverage</option>
							<option value="shopping_and_lifestyle" <?php if($select_record->categories=="shopping_and_lifestyle"){echo "selected";}?>>Shopping & Lifestyle</option>
							<option value="beauty_and_healthy" <?php if($select_record->categories=="beauty_and_healthy"){echo "selected";}?>>Beauty & Healthy</option>
							<option value="hotel_and_travel" <?php if($select_record->categories=="hotel_and_travel"){echo "selected";}?>>Hotel & Travel</option>
