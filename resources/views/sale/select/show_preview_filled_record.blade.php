	...
	<div class="row">
		...
		<div class="row">
			<div class="col-xs-12"><b>ผลการโทร : </b>
				@if($call_result=="yes") 
					<span>Yes</span><br />					
					<b>Privilege : </b> {{$sale_filled['feedback']}} <br />
					...
					<table class="table table-bordered table-striped">
                			<tr>
                				<td>เอกสารตอบรับ</td>
                				<td>
                					@if($sale_filled['has_reply_doc']=="1")
                						มี
                					@else
                						ไม่มี
                					@endif
                			...
                			<tr>
                				...
                				<td>
                					@if($sale_filled['has_confirm_product_img']=="1")
                						มี
                					@else
                						ไม่มี
                					@endif
                			...
                			<tr>
                				<td>ยืนยันรูปLogo</td>
                				<td>
                					@if($sale_filled['has_confirm_logo_img']=="1")
                						มี
                					@else
                						ไม่มี
                					@endif
                	...
                	<div class="col-xs-4">
                		<table class="table table-bordered table-striped">
                			...
                			<tr>
                				<td>รูปสินค้า</td>
                				<td>
                					@if($sale_filled['has_product_img']=="1")
                						มี
                					@else
                						ไม่มี
                					@endif
				...
				@elseif($call_result=="rejected")
					...
					<b>เหตุผลที่ปฏิเสธ : </b> {{$sale_filled['no_reason']}} <br />
