...
<div class="container-fluid" style="margin-left:20px;margin-right: 20px;">
	<div class="row">
		...
		{{Form::open(array('action' => 'AdminController@add_selected_record_extend','id'=>'submit_form'))}}
		{{$record_list->links()}}
		<table class="table table-bordered table-striped">
		  ...
		  @foreach ($record_list as $each_record)
			...
			<?php 
			  ...
			  <td><?php echo $record->convert_date_format_dash($each_record->yes_privilege_start); ?></td>
			  <td><?php echo $record->convert_date_format_dash($each_record->yes_privilege_end); ?></td>
		    </tr>
		   @endforeach
		  </tbody>
