...
<div class="container-fluid add-margin-20">
	<div class="row">
			...
			<div class="col-xs-12">
				...
				<table class="table table-bordered table-striped">
					...
					<tr>
						...
						<td><input type="hidden" name="branch" id="branch" value="{{$select_record->branch}}" />{{$select_record->branch}}</td>
                        <td>
                        <input type="hidden" name="branch_amount" id="branch_amount" value="{{$select_record->branch_amount}}" class="form-control"/>
				...
				<table class="table table-bordered table-striped">
					...
					<tr>
						...
						<td>
							<input type="hidden" name="province" id="province" value="{{$select_record->province}}" />
							{{$select_record->province}}
						</td>
		...
		<div class="row">
			...
			<table class="table table-bordered table-striped">
					...
					<tr>
						<td>
							<input type="hidden" name="contact_person" id="contact_person" value="{{$select_record->contact_person}}" class="form-control" />{{$select_record->contact_person}}
						</td>
	...
	<div class="row" id="yes_form">
			<div class="col-xs-12">
				<div class="row add-margin-20">
					<div class="col-xs-12">
						<label>Feedback: </label>
							<input type="text" name="feedback" id="feedback" value="{{$select_record->yes_feedback}}" class="form-control yes_form"/>
					</div>
				</div>
				<div class="row add-margin-20">
					<div class="col-xs-12">
						<label>เงื่อนไขเพิ่มเติม: </label>
							<input type="text" name="condition" id="condition" value="{{$select_record->yes_condition}}" class="form-control yes_form"/>
					</div>
				</div>
				<div class="row add-margin-20">
				<?php
					$start_priviledge_date = $select_record->yes_privilege_start;
					$yes_privilege_start = explode('-', $start_priviledge_date);
				?>
					<div class="col-xs-12">
						...
						<div class="row">
							<div class="col-xs-4">
								<div class="input-group">
									<input class="form-control yes_form datepicker" type="text" id="start_priviledge_date" name="start_priviledge_date" value="<?php echo $yes_privilege_start[2]."/".$yes_privilege_start[1]."/".$yes_privilege_start[0]; ?>"/>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row add-margin-20">
				<?php
					$end_priviledge_date = $select_record->yes_privilege_end;
					$yes_privilege_end = explode('-', $end_priviledge_date);
				?>
					<div class="col-xs-12">
						<label>End Privilege Date [ วัน / เดือน / ปี ]</label>
							<div class="row">
								<div class="col-xs-4">
									<div class="input-group">
										<input class="form-control yes_form datepicker" type="text" id="end_priviledge_date" name="end_priviledge_date" value="<?php echo $yes_privilege_end[2]."/".$yes_privilege_end[1]."/".$yes_privilege_end[0]; ?>"/>
									</div>
								</div>
							</div>
						</div>
	...
	<div class="row">
		<div class="col-xs-12">
			<a href="#" class="btn btn-primary" id="confirm_btn" onClick="">แก้ไข</a> <a href="{{url('admin/approve_record_from_sale/select_sale/'.$select_record->sale_id)}}" class="btn btn-danger">ยกเลิก</a>
		</div>
	</div>
{{Form::close()}}
</div>
