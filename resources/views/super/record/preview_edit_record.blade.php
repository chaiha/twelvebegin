...
<div class="container add-margin-left-right">
	<div class="row">
		...
		{{Form::open(array('action' => 'SuperController@submit_edit_record','id'=>'submit_form'))}}
			{{csrf_field()}}
		<div class="row">
			<div class="col-xs-2">
				<label>No.</label>
		...
		<a class="btn btn-primary" href="{{ url('super/record/edit_record/'.$record['id']) }}" role="button" id="edit_btn">Edit</a>
